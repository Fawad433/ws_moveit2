...
my_robot_interfaces__msg__LedPanelState__init(my_robot_interfaces__msg__LedPanelState * msg)
{
  ...
  // led_panel_state
  {
    bool success = rosidl_runtime_c__uint8__Sequence__init(&msg->led_panel_state, 3);
    if (!success) {
      goto abort_init_0;
    }
  }
  msg->led_panel_state.data[0] = 0;
  msg->led_panel_state.data[1] = 0;
  msg->led_panel_state.data[2] = 0;
  return true;
abort_init_0:
  return false;
}
...
my_robot_interfaces__msg__LedPanelState__fini(my_robot_interfaces__msg__LedPanelState * msg)
{
  ...
  // led_panel_state
  rosidl_runtime_c__uint8__Sequence__fini(&msg->led_panel_state);
}
...
my_robot_interfaces__msg__LedPanelState__are_equal(const my_robot_interfaces__msg__LedPanelState * lhs, const my_robot_interfaces__msg__LedPanelState * rhs)
{
  ...
  if (!rosidl_runtime_c__uint8__Sequence__are_equal(
      &(lhs->led_panel_state), &(rhs->led_panel_state)))
  {
    return false;
  }
  return true;
  ...
  my_robot_interfaces__msg__LedPanelState * output)
{
  ...
  if (!rosidl_runtime_c__uint8__Sequence__copy(
      &(input->led_panel_state), &(output->led_panel_state)))
  {
    return false;
  }
  return true;
